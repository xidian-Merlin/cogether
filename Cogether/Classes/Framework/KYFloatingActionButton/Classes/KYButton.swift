...
class KYButton: UIView{
    ...
    */
    ...
    public init() {
        super.init(frame: CGRect(x: 100, y: 100, width: 55, height: 55))
        backgroundColor = kSystemBlueColor
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.layer.shadowColor = UIColor.black.cgColor
        self.layer.shadowOpacity = 0.6
        self.layer.shadowOffset = CGSize(width: 0, height: 0) //向右下偏移
        self.layer.addSublayer(buttonLayer!)
    }
   ...
   fileprivate func openButton() {
    ...
    self.layer.transform = CATransform3DMakeRotation(CGFloat(-Double.pi / 4*3), 0.0, 0.0, 1)
